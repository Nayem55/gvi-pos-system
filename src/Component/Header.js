...
import { Box, File, FileStack } from "lucide-react"; // removed unused imports without changing behavior
    ...
    <div>
      ...
      <div className="sticky top-0 z-40 flex justify-between items-center px-4 py-3 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 shadow-sm border-b">
        <Link to="/" className="shrink-0">
          <img className="w-[96px] sm:w-[112px] hover:opacity-90 transition" src={logo} alt="Logo" />
        </Link>
      ...
      >
        ...
        <div className="relative h-full flex flex-col bg-white shadow-2xl border-r">
          ...
          <div className="flex-1 overflow-y-auto scroll-smooth px-3 py-4">
            {/* Section: General */}
            <p className="px-3 pb-2 text-[11px] font-semibold tracking-wide uppercase text-zinc-500">General</p>
            <div className="space-y-1">
              ...
              >
                <span className="flex items-center gap-3">
                  <svg className="w-7 h-7 text-zinc-700 group-hover:scale-105 transition" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                ...
                <svg className="w-4 h-4 opacity-0 group-hover:opacity-100 transition" viewBox="0 0 20 20" fill="currentColor"><path d="M7 5l5 5-5 5"/></svg>
              </Link>
              ...
              >
                <span className="flex items-center gap-3">
                  <svg className="w-7 h-7 text-zinc-700 group-hover:scale-105 transition border border-current p-1 rounded-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            {/* Section: Reports */}
            <p className="px-3 pb-2 text-[11px] font-semibold tracking-wide uppercase text-zinc-500">Reports</p>
            <div className="space-y-1">
              <Link
                to={"/dashboard"}
                className="group flex items-center justify-between gap-3 px-3 py-2 rounded-xl text-zinc-800 hover:bg-zinc-100/90 active:bg-zinc-200 transition ring-1 ring-transparent hover:ring-zinc-200"
              ...
              >
                <span className="flex items-center gap-3">
                  <img className="w-7 h-7 object-contain group-hover:scale-105 transition" alt="" src={dashboard} />
              ...
              {(user?.role === "super admin" || user?.role === "SO") && (
                ...
                >
                  <span className="flex items-center gap-3">
                    <Box size={28} className="w-7 h-7 text-zinc-700 group-hover:scale-105 transition" />
              ...
              >
                <span className="flex items-center gap-3">
                  <svg className="w-6 h-6 text-zinc-700 group-hover:scale-105 transition" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
              ...
              {user?.role && user?.role !== "SO" && (
                ...
                >
                  <span className="flex items-center gap-3">
                    <img className="w-7 h-7 object-contain group-hover:scale-105 transition" alt="" src={admin} />
            ...
            <div className="px-3 pt-3 pb-2 text-[11px] text-zinc-500">
              <p className="leading-tight">Tip: Tap outside or press the close button to dismiss.</p>
            </div>
          </div>
        </div>
      </aside>

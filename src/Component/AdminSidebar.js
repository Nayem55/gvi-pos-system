...
import { Menu, X, Package, BarChart2, Users, Layers, ChevronDown, Target, Grid, Gift, Box } from "lucide-react";
...
const AdminSidebar = () => {
  ...
  const navItems = [
    ...
    { name: "Stock Movement", path: "/admin/stock-movement", icon: <Box size={20} /> },

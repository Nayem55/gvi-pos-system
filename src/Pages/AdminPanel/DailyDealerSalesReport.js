        ...
        <div className="container mx-auto">
          ...
          {loading ? (
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Sales on {selectedDate}</h3>
                ...
                <tbody>
                  {report?.products.map((product, index) => (
                    <tr key={index} className="border-b hover:bg-gray-50">
                      ...
                      <td className="p-4 text-gray-800">৳{product.total_mrp.toFixed(2)}</td>
                      <td className="p-4 text-gray-800">৳{product.total_tp.toFixed(2)}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="text-center text-gray-600">No sales found for this date.</div>
          )}
        </div>
      </div>
    </div>

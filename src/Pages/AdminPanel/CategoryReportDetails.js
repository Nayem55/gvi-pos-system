                            ...
                            <tbody>
                                {products.map((product, index) => (
                                    <tr key={index} className="hover:bg-gray-50">
                                        ...
                                        <td className="border p-2 text-center">{product.barcode}</td>
                                        <td className="border p-2 text-center">{product.total_quantity}</td>
                                        <td className="border p-2 text-center">{product.total_tp} BDT</td>
                                        <td className="border p-2 text-center">{product.total_mrp} BDT</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
